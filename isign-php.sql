...
CREATE TABLE `cmf_user_posted` (
  ...
  `super_sign_count` int(11) NOT NULL DEFAULT '100' COMMENT '个人证书剩余设备数',
  `public_super_sign_count` int(11) NOT NULL DEFAULT '100' COMMENT '证书池剩余设备数',
